...
import './less/media768.less';
import './less/media576.less';
import './less/media1200.less';
...
Vue.component('header-menu', {
    template: `<div class="head-wrapper">
                    <a class="logo-item" v-on:click="fun()">BOUNCY</a>
                    ...
                    <div class="mobile-menu">
                        <div class="mobile-icon" v-on:click="show = !show">menu</div>
                        <div class="menu">
                            <ul class="">
                                <li><router-link to="/" exact class-active="active"><div class="hello"><div>Hello</div></div></router-link></li>
                                <li><router-link to="/services">Services</router-link></li>
...
Vue.component('header-menu', Navigation)
